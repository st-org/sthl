...
import {Highlighter,css,extractLangInfoArrayFromVSECURLs} from '../dist/mod'
...
;(async()=>{
    const langInfoArray=await extractLangInfoArrayFromVSECURLs([
        ...
        'https://cdn.jsdelivr.net/gh/microsoft/vscode/extensions/markdown-basics',
        'https://cdn.jsdelivr.net/gh/microsoft/vscode/extensions/javascript',
        'https://cdn.jsdelivr.net/gh/microsoft/vscode/extensions/typescript-basics',
        'https://cdn.jsdelivr.net/gh/microsoft/vscode/extensions/css',
        'https://cdn.jsdelivr.net/gh/microsoft/vscode/extensions/html',
    ])
    langInfoArray.push({
        name:'javascript',
        alias:['js']
    ...
    const highlighter=new Highlighter(langInfoArray)
    shell
    .append(await highlighter.highlight(js,'js'))
    .append(await highlighter.highlight(js,'non'))
    .append(await highlighter.highlight(ts,'ts'))
    .append(await highlighter.highlight(cssCase,'css'))
    .append(await highlighter.highlight(html,'html'))
    .append(await highlighter.highlight(md,'md'))
    .append(await highlighter.highlight(stdn,'stdn'))
    .append(await highlighter.highlight(stdn,'non'))
})()
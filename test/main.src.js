...
;(async()=>{
    ...
    document.body.append(await highlighter.highlightToElement(js,'js'))
    document.body.append(await highlighter.highlightToElement(js,'non'))
    document.body.append(await highlighter.highlightToElement(ts,'ts'))
    document.body.append(await highlighter.highlightToElement(cssExample,'css'))
    document.body.append(await highlighter.highlightToElement(html,'html'))
    document.body.append(await highlighter.highlightToElement(md,'md'))
    document.body.append(await highlighter.highlightToElement(stdn,'stdn'))
    document.body.append(await highlighter.highlightToElement(stdn,'non'))
})()